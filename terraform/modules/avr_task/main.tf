  ...
  container_definitions    = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "RAILS_ADDITIONAL_IPS",     value = var.container_config.additional_ips },
        ...
        { 
          ...
          value = var.container_config.active_record_encryption_primary_key
        },
        { 
          name = "ACTIVE_RECORD_ENCRYPTION_DETERMINISTIC_KEY",
          value = var.container_config.active_record_encryption_deterministic_key
        },
        { 
          name = "ACTIVE_RECORD_ENCRYPTION_KEY_DERIVATION_SALT",
          value = var.container_config.active_record_encryption_key_derivation_salt
        },
        {
        ...
        { name  = "SETTINGS__NAME", value = "AVR: Repository Audio + Video" },
        {
