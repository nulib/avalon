...
module MasterFileBehavior
  ...
  def embed_code(width, permalink_opts = {})
    begin
      ...
      "<iframe title=\"#{ ERB::Util.html_escape(embed_title) }\" src=\"#{url}\" width=\"#{width}\" height=\"#{height}\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>"
    rescue
      ""
    end
  end
