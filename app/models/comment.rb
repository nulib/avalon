...
class Comment
  ...
  LOCATIONS = ["On-campus", "Off-campus", "Campus dorm", "Wired connection", "Wireless connection", "Mobile device"]

  attr_accessor :name, :subject, :email, :nickname, :resource, :device, :browser
